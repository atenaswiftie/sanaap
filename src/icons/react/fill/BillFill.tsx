...
const SvgBillFill = (props: ComponentProps<typeof SvgIcon>) => {
      ...
      <g id="vuesax/bulk/bill">
        <g id="bill">
          <path
            id="Vector"
            opacity={0.4}
            d="M3.66809 14.47C3.66781 11.5985 3.66809 2.5 3.66809 2.5H20.3381C20.3381 2.5 20.5926 11.8612 20.498 14.5C20.4035 17.1388 20.3381 18.4076 18.9982 19.5C17.3581 20.8371 14.7939 21 11.9982 21C9.75304 21 6.37855 20.8803 4.99817 19.5C3.9981 18.5 3.66837 17.3415 3.66809 14.47Z"
            fill="#359A95"
          />
          <g id="Group">
            <path
